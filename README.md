...
Oyunlaştırılmış Öğrenme Deneyimi: Dünya'dan Ay'a yolculuk sırasında sunulan eğitici uzay bilgi kartları ve öğrenilenleri pekiştiren interaktif Doğru/Yanlış Quiz sistemi.
...
🚀 Kurulum & Çalıştırma
Önemli Not: Proje güvenlik önlemleri (CORS politikaları) nedeniyle yerel bir sunucu (local server) üzerinden çalıştırılmalıdır.

1. Depoyu klonlayın:

Bash
git clone https://github.com/ozknnberat/tua-astro-hackathon.git
...
Bash
mkdir css js
4. Dosyaları ilgili klasörlere taşıyın:

Bash
mv style.css css/
mv *.js js/
5. Yerel bir sunucu başlatın:

Bash
npx serve .
6. Tarayıcınızda görüntüleyin:
http://192.168.56.1:3000/ (veya konsolda belirtilen yerel adres) adresine giderek simülasyonu başlatın.
